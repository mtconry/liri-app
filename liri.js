...
var getMyBands = function(artist) {
    ...
    axios.get(queryURL).then(
        function(response) {
            ...
            console.log('Upcoming converts for ' + artist + '+');

            for (var i = 0; i < jsonData.length; i++) {
                var show = jsonData[i];

                // Print data about each concert
                // If a concert doesn't have region, display the country instead
                // Use moment to format the data
                console.log(
                    show.venue.city + 
                    ',' +
...
// Function determining which command is executed 
